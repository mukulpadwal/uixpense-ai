...
function ChatMessage({ message }: { message: StreamMessage }) {
  if (message.type === "user") {
    return (
      <div className="flex justify-end my-4 min-w-0 animate-in fade-in slide-in-from-right-4 duration-500">
        <div className="flex flex-row-reverse items-start gap-3 max-w-[85%] sm:max-w-[75%] md:max-w-[65%] min-w-0">
          ...
          <div className="flex flex-col items-end gap-1 min-w-0">
            <div className="px-5 py-3 rounded-3xl rounded-tr-sm bg-linear-to-br from-orange-600 to-orange-500 text-white
            shadow-lg shadow-orange-950/20 border border-orange-400/20
            max-w-full wrap-break-word overflow-hidden">
              <p className="text-sm sm:text-base leading-relaxed font-medium whitespace-pre-wrap wrap-break-word">
  ...
  if (message.type === "ai") {
    return (
      <div className="flex justify-start my-4 min-w-0 animate-in fade-in slide-in-from-left-4 duration-500">
        <div className="flex items-start gap-3 max-w-[85%] sm:max-w-[75%] md:max-w-[65%] min-w-0">
          <div className="shrink-0 mt-1">
          ...
          <div className="flex flex-col items-start gap-1 min-w-0">
            <div className="px-5 py-3 rounded-3xl rounded-tl-sm bg-white/5 backdrop-blur-md text-stone-100
            border border-white/10 shadow-xl
            max-w-full wrap-break-word overflow-hidden">

              <div className="text-sm sm:text-base leading-relaxed tracking-wide
              max-w-full overflow-x-auto wrap-break-word">
                <Markdown
                  ...
                  components={{
                    table: (props) => (
                      <div className="max-w-full overflow-x-auto">
                        <table
                          className="w-full border border-foreground/10 border-collapse text-sm"
                          {...props}
                        />
                      </div>
                    ),
                    th: (props) => (
                      <th className="border border-foreground/10 px-3 py-2 text-left" {...props} />
                    ),
                    td: (props) => (
                ...
                <div className="w-full flex items-start gap-3 px-4 py-3 rounded-xl border bg-stone-900/40 border-white/5 backdrop-blur-md group transition-all hover:border-white/10 animate-in fade-in slide-in-from-left-2 duration-300">
                  <div className="w-full flex flex-col gap-1.5">
                    {message.payload.result && (
                      <div className="px-3 py-2 rounded-lg bg-black/40 border border-white/5">
                        <pre className="text-[11px] font-mono text-stone-400 overflow-x-auto whitespace-pre-wrap wrap-break-word leading-relaxed">
